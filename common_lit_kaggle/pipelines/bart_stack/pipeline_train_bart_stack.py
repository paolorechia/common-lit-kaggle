...
from common_lit_kaggle.tasks import bart, bart_stack, data_split
from common_lit_kaggle.utils.mlflow_wrapper import mlflow


class TrainBartStackRegressionPipeline(Pipeline):
    def __init__(self) -> None:
        ...
        mlflow.log_params(
            {
                "stack": True,
                "number_of_models_in_stack": config.number_of_models_in_stack,
