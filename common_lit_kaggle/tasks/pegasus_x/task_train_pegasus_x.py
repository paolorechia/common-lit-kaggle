...
from transformers import AutoConfig, PegasusXConfig

from common_lit_kaggle.framework.task import Task
from common_lit_kaggle.modeling import (
    EarlyStopper,
    PegasusXWithRegressionHead,
    train_model,
)
...
class TrainPegasusXTask(Task):
    ...
    def run(self, context: Mapping[str, Any]) -> Mapping[str, Any]:
        ...
        bart_config: PegasusXConfig = AutoConfig.from_pretrained(
        ...
        bart_model = PegasusXWithRegressionHead.from_pretrained(
