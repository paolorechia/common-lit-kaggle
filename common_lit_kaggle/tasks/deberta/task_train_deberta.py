...
class TrainDebertaTask(Task):
    ...
    def run(self, context: Mapping[str, Any]) -> Mapping[str, Any]:
        ...
        bart_config: DebertaV2Config = AutoConfig.from_pretrained(
        ...
        bart_model = DebertaWithRegressionHead.from_pretrained(
